...
import { AuthContext } from "../../context/AuthContext";
import { useNavigate } from "react-router-dom";
// import { useFetchApprovedCards, useFetchPendingCards, useFetchRejectedCards } from "../../api/hooks/card/opCard/card";
...
export default function AdminPanel() {
  ...
  // const { data: pendingData } = useFetchPendingCards();
  // const { data: approvedData } = useFetchApprovedCards();
  // const { data: rejectedData } = useFetchRejectedCards();
  ...
  const cardCategories = [
    { title: "ONE PIECE", path: "/admin/cards/one-piece" },
    { title: "NARUTO", path: "/admin/cards/naruto" },
    { title: "DRAGON BALL", path: "/admin/cards/dragon-ball" },
    { title: "POKÉMON", path: "/admin/cards/pokemon" },
  ];
