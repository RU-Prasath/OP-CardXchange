...
import { Icon } from "@iconify/react";
import { ICONS } from "../../../../assets/icons";
import Cart from "../../../../components/card/one-piece/cart/Cart";
        ...
        <div className="bg-white rounded-xl md:rounded-3xl shadow-lg md:shadow-xl overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 p-4 md:p-8">
            ...
            <div className="lg:sticky lg:top-24">
              <div className="relative overflow-hidden rounded-xl md:rounded-2xl bg-linear-to-br from-[#f6f2ee] to-white p-4 md:p-6">
                {/* Mobile Image Gallery Indicator */}
                    ...
                    {card.images.map((_, i) => (
                      <div
                        ...
                        className={`w-2 h-2 rounded-full ${
                          activeImg === i ? "bg-[#0097a7]" : "bg-gray-300"
                        }`}
                      />
                    ))}
                  </div>
                ...
                <div className="relative aspect-square overflow-hidden rounded-lg md:rounded-xl">
                  ...
                  <div className="absolute top-3 left-3 flex flex-col gap-2">
                    ...
                    <span
                      ...
                      ${
                        card.condition === "mint" || card.condition === "Mint"
                          ? "bg-[#0097a7] text-white"
                          : card.condition === "near-mint" ||
                            card.condition === "Near-Mint"
                          ? "bg-[#fdd18e] text-[#1c1c1c]"
                  ...
                  {user && (
                    <div className="absolute top-3 right-3 flex flex-col gap-2">
                      <button
                        onClick={handleWishlistClick}
                        className="w-10 h-10 md:w-12 md:h-12 bg-white/90 backdrop-blur-sm rounded-full flex items-center justify-center shadow-lg hover:bg-white transition-all duration-300 hover:scale-110 z-10"
                        aria-label={
                          isWishlisted(card._id)
                            ? "Remove from wishlist"
                            : "Add to wishlist"
                      ...
                      {/* Mobile Share Button */}
                      {/* <button className="lg:hidden w-10 h-10 bg-white/90 backdrop-blur-sm rounded-full flex items-center justify-center shadow-lg hover:bg-white transition-all duration-300 hover:scale-110">
                      <Icon
              ...
              <div className="block mt-4 md:mt-6">
                <h3 className="text-base md:text-lg font-semibold text-[#1c1c1c] mb-2 md:mb-3">
                  Gallery
                </h3>
                <div className="flex gap-2 md:gap-3 overflow-x-auto pb-2">
            ...
            <div className="lg:pl-0">
              ...
              <div className="lg:hidden sticky top-0 z-10 bg-white/95 backdrop-blur-sm py-3 -mx-4 px-4 mb-4 border-b">
                <div className="flex justify-between items-center">
                  <div>
                    <div className="text-xs text-gray-500">Price</div>
                    <div className="text-2xl font-bold bg-linear-to-r from-[#0097a7] to-[#c0392b] bg-clip-text text-transparent">
                      ₹{card.price?.toLocaleString()}
                    </div>
                  </div>
                  {user && (
                    <button
                      ...
                      className="px-6 py-2 bg-linear-to-r from-[#c0392b] to-[#fdd18e] text-white font-bold rounded-lg text-sm"
                    >
                      Add to Cart
                    </button>
                  )}
              ...
              <div className="border-b border-[#f6f2ee] pb-4 md:pb-6">
                <div className="flex flex-col sm:flex-row justify-between items-start gap-3">
                  <div className="flex-1 min-w-0">
                    <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#1c1c1c] wrap-break-word leading-tight">
                      {card.name}
                    </h1>
                  ...
                  {user && (
                    <div className="hidden lg:flex flex-col gap-2">
                      <button
                        onClick={handleAddToCart}
                        className="px-8 py-3 bg-linear-to-r from-[#c0392b] to-[#fdd18e] text-white font-bold text-lg rounded-lg hover:shadow-lg hover:scale-[1.02] transition-all duration-300"
                      >
                        Add to Cart
                      </button>
                      <button
                        onClick={openCart}
                        className="px-8 py-3 border-2 border-[#0097a7] text-[#0097a7] font-bold text-lg rounded-lg hover:bg-[#0097a7] hover:text-white transition-all duration-300"
                      >
                        View Cart
                      </button>
                    </div>
              ...
              {/* Description */}
              <div className="py-4 md:py-6 border-b border-[#f6f2ee]">
                <h2 className="text-lg md:text-xl font-bold text-[#1c1c1c] mb-2 md:mb-3 flex items-center gap-2">
                  <Icon icon="mdi:card-text" className="text-[#0097a7]" />
                  Description
                </h2>
                <p className="text-gray-700 leading-relaxed text-sm md:text-base">
                  {card.description}
              ...
              {/* Features Grid */}
              <div className="py-4 md:py-6 border-b border-[#f6f2ee]">
                <h2 className="text-lg md:text-xl font-bold text-[#1c1c1c] mb-3 md:mb-4 flex items-center gap-2">
                  <Icon
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
                  {[
                    ...
                    <div
                      key={idx}
                      className="flex items-center gap-3 p-3 bg-white rounded-xl border border-[#f6f2ee] hover:border-[#fdd18e] transition-colors"
                    >
                      <div
              ...
              {card.seller && (
                <div className="py-4 md:py-6 border-b border-[#f6f2ee]">
                  <h2 className="text-lg md:text-xl font-bold text-[#1c1c1c] mb-3 md:mb-4 flex items-center gap-2">
                    <Icon icon="mdi:account" className="text-[#0097a7]" />
                    Seller Information
                  </h2>
                  <div className="flex items-center gap-3 p-4 bg-[#f6f2ee] rounded-xl">
                    <div className="w-12 h-12 rounded-full bg-linear-to-r from-[#0097a7] to-[#1c1c1c] flex items-center justify-center">
                      <Icon icon="mdi:pirate" className="text-white text-xl" />
                    </div>
                    <div>
                      <div className="font-semibold text-[#1c1c1c]">
                        {card.seller.fullName || "Verified Seller"}
                      </div>
                      <div className="text-sm text-gray-600 flex items-center gap-1">
                        <Icon icon="mdi:star" className="text-[#fdd18e]" />
              ...
              {/* Mobile Bottom Action Buttons - Sticky */}
              {user && (
                <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-4 z-20">
                  <div className="flex gap-3">
                    <button
                      onClick={handleAddToCart}
                      className="flex-1 py-3 bg-linear-to-r from-[#c0392b] to-[#fdd18e] text-white font-bold rounded-lg text-sm"
                    >
                      Add to Cart
                    </button>
                    <button
                      onClick={openCart}
                      className="flex-1 py-3 border border-[#0097a7] text-[#0097a7] font-bold rounded-lg text-sm"
                    >
                      View Cart
                    </button>
                  </div>
              ...
              {/* Desktop Login CTA */}
              {!user && (
                <div className="hidden lg:block mt-6 p-6 bg-linear-to-r from-[#f6f2ee] to-white rounded-2xl">
                  <div className="flex items-center gap-4">
                    <div className="w-16 h-16 rounded-full bg-[#0097a7]/10 flex items-center justify-center">
                      <Icon
                        icon="mdi:lock"
                        className="text-2xl text-[#0097a7]"
                      />
                    </div>
                    <div>
                    ...
                    <button
                      onClick={handleLogin}
                      className="cursor-pointer ml-auto px-6 py-2 bg-linear-to-r from-[#0097a7] to-[#1c1c1c] text-white font-semibold rounded-lg hover:shadow-lg transition-all duration-300"
                    >
                      Login / Register
                    </button>
                  </div>
